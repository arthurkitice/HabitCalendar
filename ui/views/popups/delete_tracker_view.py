...
class DeleteTrackerView(ctk.CTkFrame):
    ...
    def ui(self):
        self.label_1 = ctk.CTkLabel(self, text=i18n.t('delete.tracker.label', tracker=self.tracker), font=ctk.CTkFont(size=22, weight="bold"))
        self.label_1.grid(row=1, column=1, padx=5, pady=5, sticky="nsew")

        self.label_2 = ctk.CTkLabel(self, text=i18n.t('delete.tracker.warning'), font=ctk.CTkFont(size=16), text_color="grey")
